<cfcomponent extends="taffy.core.resource" taffy:uri="/partner/{partnerID}/reporting/bookings/value" hint="some hint about this resource">
		...
		<cfloop index="y" from="#startYear#" to="#endYear#">
			...
			<cfif y is startYear>
				<cfloop index="sm" from="#startMonth#" to="12">
					...
					AND partnerViews.partnerID = '#arguments.partnerID#'
					</cfquery>

<cfcomponent extends="taffy.core.resource" taffy:uri="/reporting/listing/views" hint="some hint about this resource">
	<cffunction name="post" access="public" output="false">
		...
		<cfset result['data']['series'] = series />
			...
			<cfset objTools.runtime('post', '/reporting/listing/views', (getTickCount() - sTime) ) />

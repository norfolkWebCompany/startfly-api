<cfcomponent extends="taffy.core.resource" taffy:uri="/reporting/activity/bookings/declined/quantity" hint="some hint about this resource">
	<cffunction name="post" access="public" output="false">
		...
		<cfset result['data']['series'] = series />
			...
			<cfset objTools.runtime('post', '/reporting/activity/bookings/declined/quantity', (getTickCount() - sTime) ) />

<cfcomponent extends="taffy.core.resource" taffy:uri="/passwordreminder" hint="some hint about this resource">
	...
	<cffunction name="post" access="public" output="false">
		...
		<cfelse>
			...
			<cfif q.recordCount is 1>
		        ...
		        <cfset emailData = {
		        	...
		        	subject = 'Startfly Password Reminder'
		        } />

		        <cfsavecontent variable="emailData.emailContent">
			        <cfoutput>
			        	<p>
				        	<strong>Your password reminder was requested from Startly.co.uk</strong>
				        </p>
		...
		<cfset objTools.runtime('post', '/passwordreminder', (getTickCount() - sTime) ) />
